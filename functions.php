...
function styles()
{
    ...
    wp_register_style('normalize', get_template_directory_uri() . '/css/normalize.min.css', array(), '3.3.2', 'all');
...
function register_badnews_menu()
{
...
add_action('init', 'register_badnews_menu');
